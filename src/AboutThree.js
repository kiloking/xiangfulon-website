    ...
    >
      ...
      >
        ...
        className=' leading-10'>
          <div className='text-[#012c48] text-lg font-bold'>Centre 選址</div>
          ...
          <div className='text-[#012c48] text-lg font-bold'>Creative 創意 </div>
          <div className='text-sm leading-6'>勇於破框思考，綜觀國際趨勢與時代浪潮，永遠要求將建築視為「藝術品」來創造。結合時代所需，融入未來科技，創造超越需求的創意建築。</div>
          <div className='text-[#012c48] text-lg font-bold'>Careness 細緻 </div>
          ...
          <div className='text-[#012c48] text-lg font-bold'>Consistent 永續</div>
